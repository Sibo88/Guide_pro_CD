...
model_path = os.path.join(model_dir, "vosk-model-en-us-0.42-gigaspeech")
model_zip_url = "https://alphacephei.com/vosk/models/vosk-model-en-us-0.42-gigaspeech.zip"
